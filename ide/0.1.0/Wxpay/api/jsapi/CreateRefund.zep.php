...
class CreateRefund extends \WXPay\Api
{
    ...
    private $api_url = "https://api.mch.weixin.qq.com/secapi/pay/refund";


    private $is_secure_pay = true;
    ...
    private $_either_groups = array("transaction_id", "out_trade_no");


    private $_required_properties = array("appid", "mch_id", "nonce_str", "sign", "transaction_id", "out_trade_no", "out_refund_no", "total_fee", "refund_fee", "op_user_id");


    private $_optional_properties = array("device_info", "refund_fee_type");
