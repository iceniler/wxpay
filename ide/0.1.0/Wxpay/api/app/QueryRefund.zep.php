...
class QueryRefund extends \WXPay\Api
{
    ...
    private $api_url = "https://api.mch.weixin.qq.com/pay/refundquery";
    ...
    private $_either_groups = array("transaction_id", "out_trade_no", "out_refund_no", "refund_id");


    private $_required_properties = array("appid", "mch_id", "nonce_str", "sign", "transaction_id", "out_trade_no", "out_refund_no", "refund_id");


    private $_optional_properties = array("device_info");
