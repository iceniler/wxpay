...
class AutocodeToOpenId extends \WXPay\Api
{

    private $api_url = "https://api.mch.weixin.qq.com/tools/authcodetoopenid";
    ...
    private $_either_groups = array("sign", "appid", "mch_id", "auth_code", "nonce_str", "sign");


    private $_required_properties = array("appid", "mch_id", "auth_code", "nonce_str", "sign");
