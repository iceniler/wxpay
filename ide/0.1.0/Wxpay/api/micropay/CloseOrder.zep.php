...
class CloseOrder extends \WXPay\Api
{
    ...
    private $api_url = "https://api.mch.weixin.qq.com/secapi/pay/reverse";
    ...
    private $_required_properties = array("appid", "mch_id", "out_trade_no", "nonce_str", "sign");


    private $_optional_properties = array("transaction_id");
