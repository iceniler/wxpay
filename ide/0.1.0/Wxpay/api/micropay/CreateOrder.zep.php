...
class CreateOrder extends \WXPay\Api
{
    ...
    private $api_url = "https://api.mch.weixin.qq.com/pay/micropay";
    ...
    private $_required_properties = array("appid", "mch_id", "nonce_str", "sign", "body", "out_trade_no", "total_fee", "spbill_create_ip", "auth_code");


    private $_optional_properties = array("device_info", "detail", "attach", "fee_type", "goods_tag", "limit_pay");
