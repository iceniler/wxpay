...
ZEPHIR_INIT_CLASS(WXPay_Api_Micropay_CloseOrder) {
	...
	zend_declare_property_string(wxpay_api_micropay_closeorder_ce, SL("api_url"), "https://api.mch.weixin.qq.com/secapi/pay/reverse", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_bool(wxpay_api_micropay_closeorder_ce, SL("is_secure_pay"), 1, ZEND_ACC_PRIVATE TSRMLS_CC);
	...
	zend_declare_property_null(wxpay_api_micropay_closeorder_ce, SL("_either_groups"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_micropay_closeorder_ce, SL("_required_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_micropay_closeorder_ce, SL("_optional_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);
