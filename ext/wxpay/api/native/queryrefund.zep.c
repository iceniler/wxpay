...
ZEPHIR_INIT_CLASS(WXPay_Api_Native_QueryRefund) {

	ZEPHIR_REGISTER_CLASS_EX(WXPay\\Api\\Native, QueryRefund, wxpay, api_native_queryrefund, wxpay_api_ce, NULL, 0);

	zend_declare_property_string(wxpay_api_native_queryrefund_ce, SL("api_url"), "https://api.mch.weixin.qq.com/pay/refundquery", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_bool(wxpay_api_native_queryrefund_ce, SL("is_secure_pay"), 0, ZEND_ACC_PRIVATE TSRMLS_CC);
	 ...
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("appid"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("mch_id"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("device_info"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("nonce_str"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("sign"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("transaction_id"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("out_trade_no"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("out_refund_no"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_5
	 */
	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("refund_id"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("_either_groups"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("_required_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_queryrefund_ce, SL("_optional_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);

	wxpay_api_native_queryrefund_ce->create_object = zephir_init_properties_WXPay_Api_Native_QueryRefund;
	return SUCCESS;

}

static zend_object_value zephir_init_properties_WXPay_Api_Native_QueryRefund(zend_class_entry *class_type TSRMLS_DC) {
