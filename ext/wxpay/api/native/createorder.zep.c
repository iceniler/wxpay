...
ZEPHIR_INIT_CLASS(WXPay_Api_Native_CreateOrder) {
	...
	ZEPHIR_REGISTER_CLASS_EX(WXPay\\Api\\Native, CreateOrder, wxpay, api_native_createorder, wxpay_api_ce, NULL, 0);

	zend_declare_property_string(wxpay_api_native_createorder_ce, SL("api_url"), "https://api.mch.weixin.qq.com/pay/unifiedorder", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_bool(wxpay_api_native_createorder_ce, SL("is_secure_pay"), 0, ZEND_ACC_PRIVATE TSRMLS_CC);
	...
	zend_declare_property_null(wxpay_api_native_createorder_ce, SL("_either_groups"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_createorder_ce, SL("_required_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_native_createorder_ce, SL("_optional_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);
