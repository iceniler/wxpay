...
ZEPHIR_INIT_CLASS(WXPay_Api_App_QueryOrder) {

	ZEPHIR_REGISTER_CLASS_EX(WXPay\\Api\\App, QueryOrder, wxpay, api_app_queryorder, wxpay_api_ce, NULL, 0);

	zend_declare_property_string(wxpay_api_app_queryorder_ce, SL("api_url"), "https://api.mch.weixin.qq.com/pay/orderquery", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_bool(wxpay_api_app_queryorder_ce, SL("is_secure_pay"), 0, ZEND_ACC_PRIVATE TSRMLS_CC);
	 ...
	 */
	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("appid"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/app.php?chapter=9_2&index=4
	 */
	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("mch_id"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/app.php?chapter=9_2&index=4
	 */
	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("transaction_id"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/app.php?chapter=9_2&index=4
	 */
	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("out_trade_no"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/app.php?chapter=9_2&index=4
	 */
	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("nonce_str"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @see https://pay.weixin.qq.com/wiki/doc/api/app.php?chapter=9_2&index=4
	 */
	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("sign"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("_either_groups"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("_required_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(wxpay_api_app_queryorder_ce, SL("_optional_properties"), ZEND_ACC_PRIVATE TSRMLS_CC);

	wxpay_api_app_queryorder_ce->create_object = zephir_init_properties_WXPay_Api_App_QueryOrder;
	return SUCCESS;

}

static zend_object_value zephir_init_properties_WXPay_Api_App_QueryOrder(zend_class_entry *class_type TSRMLS_DC) {
