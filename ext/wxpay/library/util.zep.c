...
PHP_METHOD(WXPay_Library_Util, make_sign) {
	...
	zval *key = NULL, *_9;
	zval *apiObject, *key_param = NULL, *v = NULL, *signBody = NULL, *_0, *_1, *_2 = NULL, **_5, *_10, *_6$$3 = NULL, *_7$$4 = NULL, *_8$$4 = NULL;
	...
	ZEPHIR_INIT_VAR(_10);
	zephir_md5(_10, signBody);
	zephir_fast_strtoupper(return_value, _10);
	RETURN_MM();
...
PHP_METHOD(WXPay_Library_Util, genRandomString) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_shuffle", NULL, 13, template);
	zephir_check_call_status();
...
PHP_METHOD(WXPay_Library_Util, convertXmlToArray) {
	...
	ZEPHIR_CALL_FUNCTION(&xmlObj, "simplexml_load_string", NULL, 14, xml);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(resp_array);
	array_init(resp_array);
	ZEPHIR_CALL_FUNCTION(&properties, "get_object_vars", NULL, 4, xmlObj);
	zephir_check_call_status();
	zephir_is_iterable(properties, &_1, &_0, 0, 0, "wxpay/library/util.zep", 52);
	for (
...
PHP_METHOD(WXPay_Library_Util, convertArrayToXml) {
	...
	zephir_is_iterable(arr, &_1, &_0, 0, 0, "wxpay/library/util.zep", 72);
	for (
	  ; zephir_hash_get_current_data_ex(_1, (void**) &_2, &_0) == SUCCESS
	  ; zephir_hash_move_forward_ex(_1, &_0)
	) {
...
PHP_METHOD(WXPay_Library_Util, getRealIp) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "getenv", &_2, 15, &_0);
	zephir_check_call_status();
	_3 = zephir_is_true(_1);
	if (_3) {
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "HTTP_CLIENT_IP", 0);
		ZEPHIR_CALL_FUNCTION(&_4, "getenv", &_2, 15, &_0);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "unknown", 0);
		ZEPHIR_CALL_FUNCTION(&_5, "strcasecmp", NULL, 16, _4, &_0);
		zephir_check_call_status();
		_3 = zephir_is_true(_5);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "HTTP_X_FORWARDED_FOR", 0);
	ZEPHIR_CALL_FUNCTION(&_6, "getenv", &_2, 15, &_0);
	zephir_check_call_status();
	_7 = zephir_is_true(_6);
	if (_7) {
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "HTTP_X_FORWARDED_FOR", 0);
		ZEPHIR_CALL_FUNCTION(&_8, "getenv", &_2, 15, &_0);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "unknown", 0);
		ZEPHIR_CALL_FUNCTION(&_9, "strcasecmp", NULL, 16, _8, &_0);
		zephir_check_call_status();
		_7 = zephir_is_true(_9);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "REMOTE_ADDR", 0);
	ZEPHIR_CALL_FUNCTION(&_10, "getenv", &_2, 15, &_0);
	zephir_check_call_status();
	_11 = zephir_is_true(_10);
	if (_11) {
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "REMOTE_ADDR", 0);
		ZEPHIR_CALL_FUNCTION(&_12, "getenv", &_2, 15, &_0);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "unknown", 0);
		ZEPHIR_CALL_FUNCTION(&_13, "strcasecmp", NULL, 16, _12, &_0);
		zephir_check_call_status();
		_11 = zephir_is_true(_13);
	}
	_14 = zephir_array_isset_string(_SERVER, SS("REMOTE_ADDR"));
	if (_14) {
		zephir_array_fetch_string(&_15, _SERVER, SL("REMOTE_ADDR"), PH_NOISY | PH_READONLY, "wxpay/library/util.zep", 95 TSRMLS_CC);
		_14 = zephir_is_true(_15);
	}
	_16 = _14;
	if (_16) {
		zephir_array_fetch_string(&_17, _SERVER, SL("REMOTE_ADDR"), PH_NOISY | PH_READONLY, "wxpay/library/util.zep", 95 TSRMLS_CC);
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "unknown", 0);
		ZEPHIR_CALL_FUNCTION(&_18, "strcasecmp", NULL, 16, _17, &_0);
		zephir_check_call_status();
	...
	if (_3) {
		...
		ZEPHIR_CALL_FUNCTION(&ip, "getenv", &_2, 15, &_19$$3);
		zephir_check_call_status();
	} else if (_7) {
		ZEPHIR_SINIT_VAR(_20$$4);
		ZVAL_STRING(&_20$$4, "HTTP_X_FORWARDED_FOR", 0);
		ZEPHIR_CALL_FUNCTION(&ip, "getenv", &_2, 15, &_20$$4);
		zephir_check_call_status();
	} else if (_11) {
		ZEPHIR_SINIT_VAR(_21$$5);
		ZVAL_STRING(&_21$$5, "REMOTE_ADDR", 0);
		ZEPHIR_CALL_FUNCTION(&ip, "getenv", &_2, 15, &_21$$5);
		zephir_check_call_status();
	} else if (_16) {
		ZEPHIR_OBS_NVAR(ip);
		zephir_array_fetch_string(&ip, _SERVER, SL("REMOTE_ADDR"), PH_NOISY, "wxpay/library/util.zep", 96 TSRMLS_CC);
	} else {
		ZEPHIR_INIT_NVAR(ip);
...
PHP_METHOD(WXPay_Library_Util, callWeChatApi) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *apiUri_param = NULL, *xml_param = NULL, *cert_param = NULL, *key_param = NULL, *data = NULL, *error_no = NULL, *error_msg = NULL, *ch = NULL, _0 = zval_used_for_init, _1 = zval_used_for_init, _3$$3 = zval_used_for_init, _4$$3 = zval_used_for_init, *_6$$5, *_7$$5;
	zval *apiUri = NULL, *xml = NULL, *cert = NULL, *key = NULL;

	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 2, 2, &apiUri_param, &xml_param, &cert_param, &key_param);
	...
	ZEPHIR_CALL_FUNCTION(&ch, "curl_init", NULL, 17);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, 13);
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, 30);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 10002);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_0, apiUri);
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 64);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_0, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 81);
	...
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 42);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_0, ZEPHIR_GLOBAL(global_false));
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 19913);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_0, ZEPHIR_GLOBAL(global_true));
	...
	if (!(ZEPHIR_IS_EMPTY(cert))) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_3$$3, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_3$$3);
		ZVAL_LONG(&_3$$3, 10025);
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_3$$3, cert);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_3$$3);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_3$$3, key);
		zephir_check_call_status();
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 47);
	...
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_LONG(&_0, 10015);
	ZEPHIR_CALL_FUNCTION(NULL, "curl_setopt", &_2, 18, ch, &_0, xml);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&data, "curl_exec", NULL, 19, ch);
	zephir_check_call_status();
	if (!(ZEPHIR_IS_EMPTY(data))) {
		ZEPHIR_CALL_FUNCTION(NULL, "curl_close", &_5, 20, ch);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_SELF("convertxmltoarray", NULL, 0, data);
		zephir_check_call_status();
		RETURN_MM();
	} else {
		ZEPHIR_CALL_FUNCTION(&error_no, "curl_errno", NULL, 21, ch);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&error_msg, "curl_error", NULL, 22, ch);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "curl_close", &_5, 20, ch);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_6$$5, "wxpay/library/util.zep", 152 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
