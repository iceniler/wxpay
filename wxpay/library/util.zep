...
class Util {
     ...
     */
    public static function callWeChatApi(string! apiUri, string! xml, string! cert = null, string! key = null)
    {
        ...
        if ! empty cert {
            ...
            //curl_setopt(ch, CURLOPT_CAINFO, $config->application->certsDir . 'wechat/rootca.pem');
        }
